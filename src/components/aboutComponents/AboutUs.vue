...
<template>
    <div class="container">
      ...
      <p class=" font-normal text-xs sm:text-base sm:leading-7  lg:w-[484px]">
    ...
    <div>
        <img class="w-full" src="/img/group-of-people-sitting-indoors-3184360.png" alt="group people image">
    </div>
  </div>
    </div>
